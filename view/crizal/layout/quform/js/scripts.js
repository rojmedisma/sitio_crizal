...
(function ($) {
	$(window).on('load', function () {
		// Preload images
		var images = [
			v_dir_layout+'quform/images/close.png',
			v_dir_layout+'quform/images/success.png',
			v_dir_layout+'quform/images/error.png',
			v_dir_layout+'quform/images/default-loading.gif'
		];
